...
function updateStatus() {
    chrome.storage.local.get('activeDevice', (result) => {
        ...
        if (result.activeDevice) {
            ...
            const deviceType = device.type === 'video' ? '🎬 Video' : '📸 Foto';
            ...
            statusBox.innerHTML = `
                <div class="status-active">
                    ...
                    <p><strong>Indice:</strong> #${device.index + 1}</p>
            ...
            devicesList.innerHTML = '<p class="no-devices">Carregue midia na pagina para ativar dispositivos</p>';
        }
    });
}
